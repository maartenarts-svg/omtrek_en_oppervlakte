...
function init33FormulasGebruiken(container, onComplete) {
    ...
    const CORRECT_FORMULA = {
        vierkant: 'f1', rechthoek: 'f2', ruit: 'f1',
        parallellogram: 'f3', trapezium: 'f3', vierhoek: 'f3', driehoek: 'f3'
    };
    ...
    let currentQ        = 0;   // 0 = voorbeeld, 1–7 = echte vragen
    let totalPoints     = 0;
    ...
    function renderQuestion(n) {
        ...
        container.innerHTML = `
            <div class="exercise-container">
                ...
                <div class="question-card">
                    ...
                    <p class="hint-text">Tip: typ <kbd>*</kbd> om het maalteken &middot; in te voegen.</p>
        ...
        // * → · in berekeningsveld
        document.getElementById('ex33-calc').addEventListener('keydown', e => {
            if (e.key !== '*') return;
            e.preventDefault();
    ...
    function addCSS33() {
        if (document.getElementById('ex33-style')) return;
