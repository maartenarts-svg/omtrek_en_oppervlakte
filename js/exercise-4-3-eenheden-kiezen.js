...
function initOppervlakteEenhedenKiezen(container, onComplete) {
    ...
    function selectQuestions() {
        ...
        // Vul aan tot 8 vragen (willekeurig, zonder herhaling)
    ...
    function render() {
        ...
        container.innerHTML = `
            <div class="exercise-container">
                ...
                <div class="question-card">
                    ...
                    <div class="opp-unit-select-area">
                        <select id="unitSelect" class="opp-unit-select">
        ...
        document.getElementById('referenceModal').addEventListener('click', e => {
            if (e.target.id === 'referenceModal') document.getElementById('referenceModal').classList.remove('active');
        });
    }
        ...
        if (correct) {
            ...
            feedbackArea.innerHTML = `
                <div class="feedback-message feedback-correct">
                    ...
                    <button class="btn btn-primary" onclick="window.nextOppUnitQuestion()">OK</button>
                </div>
            `;
            ...
            feedbackArea.innerHTML = `
                <div class="feedback-message feedback-incorrect">
                    ...
                    <button class="btn btn-primary" onclick="window.retryOppUnitQuestion()">OK</button>
                </div>
            `;
        } else {
            const parts = question.text.split('...');
            const correctText = parts[0] + `<span style="color: var(--color-primary); font-weight: 700;">${displayUnit(question.answer)}</span>` + parts[1];
            feedbackArea.innerHTML = `
                <div class="feedback-message feedback-incorrect">
    ...
    window.retryOppUnitQuestion = function() {
        document.getElementById('unitSelect').value = '';
        document.getElementById('checkBtn').style.display = 'block';
        document.getElementById('feedbackArea').innerHTML = '';
    };

    window.nextOppUnitQuestion = function() {
        currentQuestion++;
    ...
    function addCSS() {
        if (document.getElementById('oppervlakte-eenheden-kiezen-css')) return;
        const style = document.createElement('style');
        style.id = 'oppervlakte-eenheden-kiezen-css';
        style.textContent = `
            .opp-unit-select-area {
                margin: 2rem 0;
                display: flex;
            ...
            .opp-unit-select:focus {
                outline: none;
                border-color: var(--color-primary);
            }
            .opp-unit-select:disabled {
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { initOppervlakteEenhedenKiezen };
}
