...
function initEenhedenVoorvoegsels(container, onComplete) {
    ...
    function showFeedback(correct, type, variant = '') {
        ...
        // Hide check button when showing feedback
        ...
        // Disable inputs if moving to next question
    ...
    window.retryQuestion = function() {
        // Clear feedback and show check button again
        const feedbackArea = document.getElementById('feedbackArea');
        const checkBtn = document.getElementById('checkBtn');
        ...
        // For fill-three questions, keep the input values (user can correct them)
        // For other types, the inputs are already cleared by the specific handlers
    };
