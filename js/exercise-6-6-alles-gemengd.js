...
function init66AllesGemengd(container, onComplete) {
    ...
    function renderExample() {
        container.innerHTML = `
            <div class="exercise-container">
                <div class="question-card">
                    ...
                    <div class="ex33-fig" id="ex66-fig-eg"></div>
        ...
        drawFiguur(document.getElementById('ex66-fig-eg'), 'vierkant', {
            factor: 1, rotation: 0,
    ...
    function renderQuestion(n) {
        ...
        container.innerHTML = `
            <div class="exercise-container">
                ...
                <div class="question-card">
                    ...
                    <p class="ex54-subtitle">Je mag ICT gebruiken voor de berekening.</p>
                    <div class="ex33-fig" id="ex66-fig"></div>
                    <div class="ex33-rows">
                        <div class="ex33-row">
                            <span class="ex33-label">Formule:</span>
                            <span class="ex33-p-label">${pLabel} =</span>
                            <div class="ex33-cs" id="ex66-cs" data-value="">
                        ...
                        <div class="ex33-row ex33-row-calc">
                            <span class="ex33-label">Berekening in</span>
                            <select id="ex66-unit" class="ex33-unit">${unitOptsHtml}</select>
                            <span>:</span>
                            <span class="ex33-p-label">${pLabel} =</span>
                            <input id="ex66-calc" class="ex33-calc" type="text" autocomplete="off" placeholder="berekening">
                            <span>${calcSep}</span>
                            <input id="ex66-ans" class="ex33-ans" type="text" autocomplete="off" placeholder="antwoord">
                        </div>
                        <div class="ex33-row ex33-sentence">
                            Antwoord: De ${sentenceWord} is
                            <span id="ex66-ans-disp" class="ex33-val">...</span>
                            <span id="ex66-unit-disp" class="ex33-val">...</span>.
                        </div>
                    </div>
        ...
        // Teken figuur — driehoek-hoogte geeft waarden terug
        const figEl = document.getElementById('ex66-fig');
        if (isDriehoek) {
        ...
        const ansEl  = document.getElementById('ex66-ans');
        const unitEl = document.getElementById('ex66-unit');
        const calcEl = document.getElementById('ex66-calc');

        function updateRow3() {
            document.getElementById('ex66-ans-disp').textContent  = ansEl.value.trim()  || '...';
            document.getElementById('ex66-unit-disp').textContent = unitEl.value || '...';
        }
        ...
        document.getElementById('checkBtn').addEventListener('click', () => {
            qAttempts++;
            const formula = document.getElementById('ex66-cs').dataset.value || '';
    ...
    function fillCorrectAnswer(data) {
        const cs      = document.getElementById('ex66-cs');
        ...
        document.getElementById('ex66-unit').value = correctUnit;

        document.getElementById('ex66-calc').value = buildCalcCorrect(data);

        const ansStr = String(data.answer);
        document.getElementById('ex66-ans').value             = ansStr;
        document.getElementById('ex66-ans-disp').textContent  = ansStr;
        document.getElementById('ex66-unit-disp').textContent = correctUnit;
    }
    ...
    function checkCalcDriehoekOpp(basis, h, input) {
        ...
        const m = n.match(/^(.+)[·](.+)[:/]2$/);
        if (!m) {
            // Controleer of ze de deling vergaten
    ...
    function genQuestion(fig, task) {
        ...
        switch (fig) {
            ...
            case 'driehoek-hoogte': {
                ...
                answer  = null; // ingevuld bij renderQuestion na drawFiguur
                break;
            }
        }
    ...
    function addCSS66() {
        if (['ex33-style','ex36-style','ex54-style','ex511-style','ex66-style'].some(id => document.getElementById(id))) return;
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { init66AllesGemengd };
}
